...
if STRAICO_API_KEY.strip().upper() == "TEST":
    ...
    from .straico import prompt_completion, list_model, list_agents, delete_agent,user_detail, image_generation, list_rags, delete_rag, create_rag, get_model_mapping, create_agent, update_agent
